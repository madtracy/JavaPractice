package tracy.encryption.asymmetric;
...
import tracy.encryption.Con2figureEncryptAndDecrypt;
...
public class RSA {
	...
	public static Map<String, String> generateKeyPair() throws Exception {
		...
		String pub = new String(Base64.encodeBase64(publicKeyBytes),
				Con2figureEncryptAndDecrypt.CHAR_ENCODING);
		/** 得到私钥 */
	...
	public static String encrypt(String source, String publicKey)
		...
		Cipher cipher = Cipher.getInstance(Con2figureEncryptAndDecrypt.RSA_ALGORITHM);
	...
	public static String sign(String content, String privateKey) {
		String charset = Con2figureEncryptAndDecrypt.CHAR_ENCODING;
		try {
